...
// --- region: imports
use recursion::{
    dynamic_programming::{dp_fibonacci_1, dp_fibonacci_2, dp_make_change_with_least_coin, mm_make_change_with_least_coin},
    recursion::{fibonacci, make_change_with_least_coin, num_to_string, sum_of_nums, tower_of_hanoi},
    tail_recursion::tail_sum_of_nums,
};
...
fn main() {
    ...
    src_peg.push(1); src_peg.push(2); src_peg.push(3); src_peg.push(4); src_peg.push(5);
    ...
    let start = Instant::now();
    println!(">dynamic programming - fibonacci 1: {}", dp_fibonacci_1(15));
    let duration = start.elapsed();
    println!("-->Time: {:?} ns", duration.as_nanos());

    let start = Instant::now();
    println!(">dynamic programming - fibonacci 2: {}", dp_fibonacci_2(15));
    let duration = start.elapsed();
    println!("-->Time: {:?} ns", duration.as_nanos());
